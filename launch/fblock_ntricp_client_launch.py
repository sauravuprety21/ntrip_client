...
def generate_launch_description():
      """
      Launch an ntrip client connected to UCalgary, Engineering F Block Roof Trimble NetR9 receiver. 
        host: 136.159.122.145
        port: 2101
        mountpoint: F_BLOCK_BASE_RTCM
      """
      return LaunchDescription([
          # Declare arguments with default values
          DeclareLaunchArgument('namespace',             default_value='/'),
          DeclareLaunchArgument('node_name',             default_value='rtcm'),
          DeclareLaunchArgument('debug',                 default_value='false'),
          DeclareLaunchArgument('host',                  default_value='136.159.122.145'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='F_BLOCK_BASE_RTCM'),
